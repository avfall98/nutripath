      ...
      {isReal && entries.length > 0 && (
        <div className="hidden justify-center border-t border-white/10 pt-2 md:flex">
          <button
            ...
            onClick={() => setAddOpen(true)}
            aria-label="Add food"
            className="flex size-8 items-center justify-center rounded-full border border-white/15 text-white/63 transition-colors hover:border-primary hover:text-primary"
          >
            <Plus className="size-4" />
          </button>
        </div>
